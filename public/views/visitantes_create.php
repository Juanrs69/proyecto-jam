...
<div class="container py-4">
  ...
  <?php $pageTitle = 'Nuevo visitante'; $breadcrumbs = [['label'=>'Visitantes','href'=>($GLOBALS['basePath'] ?? '').'/visitantes'], ['label'=>$pageTitle]]; $showSearch=false; include __DIR__ . '/partials/ui/header.php'; ?>

  <?php if (!empty($error)): ?>
    <div class="alert alert-danger"><?= htmlspecialchars($error) ?></div>
  <?php endif; ?>

  <form method="post" action="<?= htmlspecialchars($GLOBALS['basePath'] ?? '') ?>/visitantes" class="col-md-6 col-lg-5">
